    ...
    'navigation' => [
        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'unduh-profil-id', 'label' => 'Unduh Profil (ID)', 'href' => '/admin/profil/unduh-profil-id', 'sourceHref' => $baseUrl.'/unduh/profil-cea-versi-ponsel/', 'description' => 'Dokumen profil CEA versi bahasa Indonesia.'],
                ['key' => 'download-profile-en', 'label' => 'Download Profile (EN)', 'href' => '/admin/profil/download-profile-en', 'sourceHref' => $baseUrl.'/', 'description' => 'Dokumen profil CEA versi bahasa Inggris.'],
            ],
        ],
        [
            'key' => 'regio',
        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'simpul-pfb', 'label' => 'Simpul PFB', 'href' => '/admin/koneksi/simpul-pfb', 'sourceHref' => $baseUrl.'/', 'description' => 'Kanal simpul dan jejaring pendukung berbasis wilayah.'],
                ...
                ['key' => 'telisik', 'label' => 'Telisik', 'href' => '/admin/koneksi/telisik', 'sourceHref' => $baseUrl.'/', 'description' => 'Kanal observasi, pembacaan isu, dan penelusuran data.'],
                ...
                ['key' => 'sake-mite', 'label' => 'Sake-Mite', 'href' => '/admin/koneksi/sake-mite', 'sourceHref' => $baseUrl.'/', 'description' => 'Kanal koneksi komunitas dan pertukaran praktik baik.'],
                ['key' => 'civil-colony', 'label' => 'Civil Colony', 'href' => '/admin/koneksi/civil-colony', 'sourceHref' => $baseUrl.'/', 'description' => 'Ruang kolektif untuk koneksi masyarakat sipil.'],
            ],
        ],
