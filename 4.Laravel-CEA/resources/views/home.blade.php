...
<style>
    ...
    .cea-landing-hero__actions, .cea-footer-actions { display: flex; flex-wrap: wrap; gap: 12px; }
    ...
    .cea-focus-card p, .cea-governance-card p, .cea-menu-card p, .cea-landing-footer p { color: #67464b; font-size: 15px; line-height: 1.75; margin: 0; }
    ...
    @media (max-width: 991px) {
        .cea-landing-hero__grid, .cea-governance-grid, .cea-footer-grid { grid-template-columns: 1fr; }
