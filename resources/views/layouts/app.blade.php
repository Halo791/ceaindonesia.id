...
<head>
    ...
    <style>
        ...
        .kso-wordmark--header.kso-wordmark--compact { aspect-ratio: 1 / 1; border-radius: 999px; height: 92px; padding: 8px; width: 92px; }
        ...
        @media (max-width: 991px) {
            ...
            .kso-wordmark--header.kso-wordmark--compact { height: 76px; width: 76px; }
