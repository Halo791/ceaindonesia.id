                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-4 col-md-6 col-sm-6 order-2 order-lg-0">
                                <div className="header__top-search">
                                    <form action="#">
                                        <input type="text" placeholder="Cari kabar, rilis, dan referensi..." />
                                    </form>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-4 col-md-3 col-sm-6 order-3 d-none d-sm-block">
                                <div className="header__top-right">
                                    <ul className="list-wrap">
                                        <li className="news-btn"><Link href="/admin" className="btn"><span className="btn-text">panel admin</span></Link></li>
                                        <li className="lang">
                                            <div className="dropdown">
                                                ...
                                                <ul className={`dropdown-menu ${langToggle ? "show" : ""}`}>
                                                    <li><Link className="dropdown-item" href="#">EN</Link></li>
                                                    <li><Link className="dropdown-item" href="#">ID</Link></li>
                                                </ul>
                                            </div>
                                        </li>
                                    </ul>
