                        ...
                        <div className="section__title-wrap mb-40">
                            <div className="row align-items-end">
                                ...
                                <div className="col-sm-6">
                                    <div className="section__read-more text-start text-sm-end">
                                        <Link href="/blog">
                                            More Category <i className="far fa-long-arrow-right" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-8 col-lg-7">
                                <div className="video__post-item big-post">
                                    <div className="video__post-thumb">
                                        <Link href="/blog/42">
                                            <img src="/assets/img/interior/interior_12.jpg" alt="img" />
                                        </Link>
                                    ...
                                    <div className="video__post-content">
                                        ...
                                        <h3 className="title tgcommon__hover">
                                            <Link href="/blog/42">The multiverse is a hypothetical group of multiple universes.</Link>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="handpicked__item big-post">
                                    ...
                                    <div className="handpicked__content">
                                        ...
                                        <h2 className="title tgcommon__hover">
                                            <Link href="/blog/46">The multiverse is a hypothetical group of multiple universes.</Link>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div className="handpicked__item small-post">
                                                    ...
                                                    <div className="handpicked__content">
                                                        ...
                                                        <h4 className="title tgcommon__hover">
                                                            <Link href={`/blog/${item.id}`}>Scientists speculate that ours might not be held.</Link>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
