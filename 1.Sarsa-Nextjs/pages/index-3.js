                                ...
                                <div className="trending__post">
                                    ...
                                    <div className="trending__post-content">
                                        <ul className="tgbanner__content-meta list-wrap">
                                            ...
                                            <li>
                                                <span className="by">By</span> <Link href="/blog">miranda h.</Link>
                                            </li>
                                        </ul>
                                        <h4 className="title tgcommon__hover">
                                            <Link href="/blog/51">Scientists speculate that ours might not be held</Link>
                                        </h4>
                                ...
                                <div className="tgbanner__big-post text-center">
                                    ...
                                    <div className="tgbanner__big-post-content">
                                        ...
                                        <h3 className="title tgcommon__hover">
                                            <Link href="/blog/52">The multiverse is a hypothetical group of multiple universes.</Link>
                                        </h3>
                                        <Link href="/blog/52" className="read-more">
                                    ...
                                    <ul className="tgbanner__trending-post-list list-wrap">
                                        <li>
                                            ...
                                            <div className="tgbanner__trending-post-content">
                                                ...
                                                <h4 className="title tgcommon__hover">
                                                    <Link href="/blog/1">That share an universals hierarchy a large...</Link>
                                                </h4>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div className="tgbanner__trending-post-content">
                                                ...
                                                <h4 className="title tgcommon__hover">
                                                    <Link href="/blog/1">Why we need guidelines for brain originated...</Link>
                                                </h4>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div className="tgbanner__trending-post-content">
                                                ...
                                                <h4 className="title tgcommon__hover">
                                                    <Link href="/blog/1">Universes were originated from another...</Link>
                                                </h4>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div className="container">
                        <div className="col-12">
                            <div className="advertisement__image text-center">
                                <Link href="#">
                                    <img src="/assets/img/others/advertisement.png" alt="advertisement" />
                                </Link>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="row align-items-end">
                                ...
                                <div className="col-sm-6">
                                    <div className="section__read-more text-start text-sm-end">
                                        <Link href="/blog">
                                            More Recent Post <i className="far fa-long-arrow-right" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="col-lg-4 col-sm-6" key={i}>
                                    <div className="featured__post">
                                        ...
                                        <div className="featured__content">
                                            <h4 className="title tgcommon__hover">
                                                <Link href={`/blog/${item.id}`}>A hypothetical collection of potentially diverse</Link>
                                            </h4>
                                            <ul className="post__activity list-wrap">
                                                <li>
                                                    <i className="fal fa-signal" /> 1.0k
                            ...
                            <div className="col-xl-9 col-lg-8">
                                <div className="section__title-wrap mb-40">
                                    <div className="row align-items-end">
                                        ...
                                        <div className="col-sm-6">
                                            <div className="section__read-more text-start text-sm-end">
                                                <Link href="/blog">
                                                    More Latest Post <i className="far fa-long-arrow-right" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="latest__post-more text-center">
                                    <Link href="#" id="loadMore" className="btn">
                                        <span className="text">Load More</span> <i className="far fa-plus" />
                                    </Link>
                                </div>
                            </div>
