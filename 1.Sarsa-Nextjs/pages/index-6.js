                                ...
                                <div className="tgbanner__five-item big-post">
                                    ...
                                    <div className="tgbanner__five-content">
                                        ...
                                        <h2 className="title tgcommon__hover">
                                            <Link href="/blog/98">The multiverse is a hypothetical group of multiple universes.</Link>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 d-lg-block gx-30">
                                <div className="tgbanner__five-item small-post">
                                    ...
                                    <div className="tgbanner__five-content">
                                        ...
                                        <h2 className="title tgcommon__hover">
                                            <Link href="/blog/99">That share an universals hierarchy a large camp or burger.</Link>
                                        </h2>
                                    </div>
                                </div>
                                <div className="tgbanner__five-item small-post">
                                    ...
                                    <div className="tgbanner__five-content">
                                        ...
                                        <h2 className="title tgcommon__hover">
                                            <Link href="/blog/100">That share an universals hierarchy a large camp or burger.</Link>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row align-items-end">
                                ...
                                <div className="col-sm-6">
                                    <div className="section__read-more text-start text-sm-end">
                                        <Link href="/blog">
                                            More Popular Post <i className="far fa-long-arrow-right" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="latest__post-item" key={i}>
                                            ...
                                            <div className="latest__post-content">
                                                ...
                                                <h3 className="title tgcommon__hover">
                                                    <Link href={`/blog/${item.id}`}>The multiverse is a hypothetical no group of the multiple universes.</Link>
                                                </h3>
                            ...
                            <div className="col-xl-6 col-lg-8">
                                <div className="handpicked__item big-post">
                                    <div className="handpicked__thumb tgImage__hover">
                                        <Link href="/blog/110">
                                            <img src="/assets/img/lifestyle/life_style13.jpg" alt="img" />
                                        </Link>
                                    </div>
                                    <div className="handpicked__content">
                                        ...
                                        <h2 className="title tgcommon__hover">
                                            <Link href="/blog/110">The multiverse is a hypothetical group of multiple universes.</Link>
                                        </h2>
                                    </div>
                                </div>
                            </div>
