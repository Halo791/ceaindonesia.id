...
('beranda', '', 'Menguatkan lokal, memperluas dampak.', 'Menguatkan Lokal, Memperluas Dampak', 'Perubahan besar tidak lahir dari satu lembaga, tapi dari ekosistem yang terhubung. Pooling Fund - KSO menghimpun dan menyalurkan dana kemanusiaan secara bersama, berbasis kebutuhan komunitas dan kepemimpinan lokal, tanpa membentuk badan hukum baru.', '/assets/img/cea/video.mp4', '/', 'active', '{"title_en":"Strengthening local action, expanding impact.","subtitle_en":"Strengthening Local Action, Expanding Impact","body_en":"Large-scale change does not grow from one institution alone, but from a connected ecosystem. Pooling Fund - KSO pools and channels humanitarian funds collectively, based on community needs and local leadership, without creating a new legal entity.","social_instagram":"","social_facebook":"","social_youtube":"","social_threads":"","qris_image_path":"","qris_recipient":"","qris_title":"","qris_title_en":"","qris_body":"","qris_body_en":"","qris_note":"","qris_note_en":"","qris_image_alt":"","primary_label":"Baca Mandat","primary_label_en":"Read Mandate","primary_href":"/profil/mandat-visi-nilai","secondary_label":"Lihat Simpul","secondary_label_en":"View Hubs","secondary_href":"/regio/simpul","panel_label":"Ekosistem KSO","panel_label_en":"KSO Ecosystem","panel_value":"7","panel_description":"Simpul regional otonom yang terhubung dalam satu mandat kolektif.","panel_description_en":"Autonomous regional hubs connected through one collective mandate."}', NOW(), NOW())
...
('profil', 'tujuan-prinsip', 'Tujuan, Prinsip, dan Karakter KSO-Pooling Fund', 'Fondasi kerja kolektif untuk respon kemanusiaan yang cepat, transparan, akuntabel, dan berakar pada komunitas.', 'KSO-Pooling Fund dibentuk untuk menghimpun dan mengelola dana kemanusiaan secara cepat, transparan, dan akuntabel.
...
Prinsip dan karakter KSO-Pooling Fund adalah kesetaraan antar anggota, satu CSO satu suara, berbasis kebutuhan komunitas, kecepatan sebagai nilai utama, transparansi sebagai aset strategis, akuntabilitas kolektif, serta local leadership dan local first.', '/assets/img/cea/tatakelola.png', 'https://ceaindonesia.id/', 'active', NOW(), NOW()),
